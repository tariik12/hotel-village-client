...
const CheckAvailability = () => {
    ...
    return (
        <div className=" bg-fixed bg-cover bg-no-repeat py-20  " style={{backgroundImage:`url(https://media.radissonhotels.net/image/radisson-blu-hotel-dhaka-water-garden/exterior/16256-113891-f63612886_4k.jpg?impolicy=GalleryLightboxFullscreen)`} } >
