...
const FoodCard = ({food}) => {
    return (
        <div>
             <div  className="hover:shadow-[#f1f1f3ef]  shadow-lg md:w-[300px] h-[470px] border-2 hover:border-orange-600 hover:shadow-xl   rounded-2xl containWid p-2 md:ms-10 bg-white mx-auto" style={{ boxShadow: '2px 2px 4px  1px #060a099f ' }} key={food._id}>
                  a
