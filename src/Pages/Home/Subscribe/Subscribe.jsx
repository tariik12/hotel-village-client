...
const Subscribe = () => {
   ...
   <div className="ms-32 md:ms-0 rounded-xl "  data-aos="fade-right">
   <Link to='/photoGraphy' className="hover:p-1"> <img src="https://i.ibb.co/HrH5ztG/image-183.png" alt="" /></Link>
   </div>
</div>
</div>
